...
import { getInitials } from "../../utilities/index.js";
import { summary, user } from "../../assets/data.js";
...
const UserList = ({ setTeam, team }) => {
    ...
    return (
        <div>
            <p className="text-fuchsia-700">Assign Task to:</p>
            <Listbox
                value={selectedUsers}
                                    ...
                                    {({ selected }) => (
                                        <>
                                            <div className={clsx("flex items-center gap-2 truncate", selected ? "font-medium" : "font-normal")}>
                                                <div className="w-6 h-6 rounded-full text-white flex items-center justify-center bg-purple-700" style={{marginLeft: '1.5rem'}}>
