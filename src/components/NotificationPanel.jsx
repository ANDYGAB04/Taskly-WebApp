                    ...
                    {data?.slice(0, 5).map((item, index) => (
                      ...
                      >
                        <div className='mt-1 h-8 w-8 flex items-center justify-center rounded-lg bg-gray-200 group-hover:bg-white'>
                          {React.cloneElement(ICONS[item.notiType], {
                            className:
                              "h-5 w-5 text-gray-600 group-hover:text-fuchsia-800", // Updated color
                          })}
                        </div>
                  ...
                  <div className='grid grid-cols-2 divide-x bg-gray-50'>
                    {callsToAction.map((item) => (
                      <Link
                        ...
                        className='flex items-center justify-center gap-x-2.5 p-3 font-semibold text-fuchsia-800 hover:bg-gray-100'
                      >
                        {item.name}
                      </Link>
                    ))}
